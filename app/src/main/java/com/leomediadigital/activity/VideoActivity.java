...
import com.leomediadigital.adapter.VideoAdapter;
import com.leomediadigital.model.VideoModel;
...
public class VideoActivity extends AppCompatActivity {
    ...
    public  void getPhotovideo(){
        ...
        progressDialog.show();
        StringRequest stringrequest1 = new StringRequest(Request.Method.POST, Constant.VIDEO, new Response.Listener<String>() {
            @Override
...
//                            JSONArray jsonaray1 = jsonobj .getJSONArray("img_video");
                            //JSONArray jsonaray2 = jsonobj .getJSONArray("Description");

                            videoModel.setId(jsonobj.getString("id"));
                            videoModel.setVideolink(jsonobj.getString("video"));
...
//                                if (type.equals("1")){
//
//                                    videoModel.setVideolink(jsonobj1.getString("img_video"));
//                                    videoModelArrayList.add(videoModel);
//
//                                }
//
