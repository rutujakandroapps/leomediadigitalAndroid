    ...
    private void loginUser() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.LOGIN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.e("TAG_Login", "onResponse: "+ response);
                try {
                    ...
                    if (jsonObject.getString("code").equalsIgnoreCase("200")) {
                        ...
                        SharedPref.setUserName(LoginActivity.this,jsonObject1.getString("name"));
                        SharedPref.setUserNumber(LoginActivity.this,jsonObject1.getString("mobile"));
                        SharedPref.setUserEmail(LoginActivity.this,jsonObject1.getString("email"));
                        ...
                        Log.e("TAAG", "onResponseLogin: " + jsonObject.getString("message"));
                        if (progressDialog != null) {
                            progressDialog.dismiss();
                        }
                    }
                    ...
                    Log.e("TAGG", "onErrorResponse1: " + e.getMessage());
                    if (progressDialog != null) {
                        progressDialog.dismiss();
                    }
                }
